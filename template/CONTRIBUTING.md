...
4. Open a pull request. CI validates every protocol in the repository — on any pull request that
   touches `protocols/` — and will tell you precisely what is wrong.
...
It is generated by CI on every push to `main` that changes `protocols/`. Hand edits are overwritten
